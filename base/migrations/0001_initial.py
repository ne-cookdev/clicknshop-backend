    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_category', to='base.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shipments', to='base.warehouse')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='warehouses',
            field=models.ManyToManyField(related_name='orders', through='base.Shipment', to='base.warehouse'),
        ),
    ]
